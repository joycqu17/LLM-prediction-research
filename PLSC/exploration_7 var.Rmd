---
title: "exploration (7 variables selection)"
output:
...
```
```{r}
write.csv(sample100_nolabel, "gss_sample_100_unlabeled.csv", row.names = FALSE)
```

```{r}
var <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_var_predictions.csv")
head(var)
```
...
```
```{r}
narrative <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_narrative_predictions.csv")
head(narrative)
```
...
df <- sample100 %>%
  ...
  select(
    ...
    age, sex, race, educ, marital, occ10, region   # <- keep whatever predictors you want
  ) %>%
  inner_join(
    var %>%
      mutate(row_id = row_number()) %>%
...
write.csv(mislabeled_comparison,
          "mislabeled_cases_comparison.csv",
          row.names = FALSE)
...
bias_by_predictor(df, educ)
bias_by_predictor(df, marital)
bias_by_predictor(df, occ10)
bias_by_predictor(df, region)
...
label_maps <- list(
  ...
  # ---- Region: your custom 1–4 mapping ----
  region = c(
    "1" = "Northeast",
    "2" = "Midwest",
    "3" = "South",
  ...
  # ---- OCC10 major category mapping ----
  # We'll assign labels based on ranges inside the function
  occ10 = c(
    "0010-0950" = "Management/Professional",
    "1000-1240" = "Service",
    "1300-1965" = "Sales/Office",
    "2000-3955" = "Construction/Maintenance",
    "4000-5940" = "Production/Transportation",
    "5950-9750" = "Military"
  )
)
...
plot_mean_error_by_predictor(df, educ)
plot_mean_error_by_predictor(df, marital)
plot_mean_error_by_predictor(df, occ10)
plot_mean_error_by_predictor(df, region)
...
write.csv(sample100_nolabel_bin, "gss_sample_100_unlabeled_bin.csv", row.names = FALSE)
```
```{r}
var_bin <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_var_predictions_bin.csv")
head(var_bin)
...
```
```{r}
narrative_bin <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_narrative_predictions_bin.csv")
head(narrative_bin)
# Extract variables
y_true_bin <- as.numeric(sample100_binary$polviews_binary)
...
# Save to CSV
write.csv(mislabeled_comparison,
          "mislabeled_cases_comparison_bin.csv",
          row.names = FALSE)
...
```{r}
df_bin$occ10 <- as.numeric(as.character(df_bin$occ10))
bias_by_predictor(df_bin, age)
bias_by_predictor(df_bin, sex)
bias_by_predictor(df_bin, race)
bias_by_predictor(df_bin, educ)
bias_by_predictor(df_bin, marital)
bias_by_predictor(df_bin, occ10)
bias_by_predictor(df_bin, region)

plot_mean_error_by_predictor(df_bin, age)
plot_mean_error_by_predictor(df_bin, sex)
plot_mean_error_by_predictor(df_bin, race)
plot_mean_error_by_predictor(df_bin, educ)
plot_mean_error_by_predictor(df_bin, marital)
plot_mean_error_by_predictor(df_bin, occ10)
plot_mean_error_by_predictor(df_bin, region)
...
write.csv(sample100_nolabel_3, "gss_sample_100_unlabeled_3.csv", row.names = FALSE)
```
```{r}
var_3 <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_var_predictions_3.csv")
head(var_3)
...
narrative_3 <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_narrative_predictions_3.csv")
head(narrative_3)
# Extract variables
y_true_3 <- as.numeric(sample100_3$polviews_3)
...
# Save to CSV
write.csv(mislabeled_comparison,
          "mislabeled_cases_comparison_3.csv",
          row.names = FALSE)
...
```
```{r}
df_3$occ10 <- as.numeric(as.character(df_3$occ10))
bias_by_predictor(df_3, age)
bias_by_predictor(df_3, sex)
bias_by_predictor(df_3, race)
bias_by_predictor(df_3, educ)
bias_by_predictor(df_3, marital)
bias_by_predictor(df_3, occ10)
bias_by_predictor(df_3, region)

plot_mean_error_by_predictor(df_3, age)
plot_mean_error_by_predictor(df_3, sex)
plot_mean_error_by_predictor(df_3, race)
plot_mean_error_by_predictor(df_3, educ)
plot_mean_error_by_predictor(df_3, marital)
plot_mean_error_by_predictor(df_3, occ10)
plot_mean_error_by_predictor(df_3, region)
```
...
write.csv(sample100_nolabel_4, "gss_sample_100_unlabeled_4.csv", row.names = FALSE)
```
```{r}
var_4 <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_var_predictions_4.csv")
head(var_4)
...
narrative_4 <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_narrative_predictions_4.csv")
head(narrative_4)
# Extract variables
y_true_4 <- as.numeric(sample100_4$polviews_4)
...
# Save to CSV
write.csv(mislabeled_comparison,
          "mislabeled_cases_comparison_4.csv",
          row.names = FALSE)
...
```
```{r}
df_4$occ10 <- as.numeric(as.character(df_4$occ10))
bias_by_predictor(df_4, age)
bias_by_predictor(df_4, sex)
bias_by_predictor(df_4, race)
bias_by_predictor(df_4, educ)
bias_by_predictor(df_4, marital)
bias_by_predictor(df_4, occ10)
bias_by_predictor(df_4, region)

plot_mean_error_by_predictor(df_4, age)
plot_mean_error_by_predictor(df_4, sex)
plot_mean_error_by_predictor(df_4, race)
plot_mean_error_by_predictor(df_4, educ)
plot_mean_error_by_predictor(df_4, marital)
plot_mean_error_by_predictor(df_4, occ10)
plot_mean_error_by_predictor(df_4, region)
```
...
write.csv(sample100_nolabel_5, "gss_sample_100_unlabeled_5.csv", row.names = FALSE)
```
```{r}
var_5 <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_var_predictions_5.csv")
head(var_5)
...
narrative_5 <- read.csv("/Users/joyqu/Desktop/PLSC/gss_gpt5_narrative_predictions_5.csv")
head(narrative_5)
# Extract variables
y_true_5 <- as.numeric(sample100_5$polviews_5)
...
# Save to CSV
write.csv(mislabeled_comparison,
          "mislabeled_cases_comparison_5.csv",
          row.names = FALSE)
...
```
```{r}
df_5$occ10 <- as.numeric(as.character(df_5$occ10))
bias_by_predictor(df_5, age)
bias_by_predictor(df_5, sex)
bias_by_predictor(df_5, race)
bias_by_predictor(df_5, educ)
bias_by_predictor(df_5, marital)
bias_by_predictor(df_5, occ10)
bias_by_predictor(df_5, region)

plot_mean_error_by_predictor(df_5, age)
plot_mean_error_by_predictor(df_5, sex)
plot_mean_error_by_predictor(df_5, race)
plot_mean_error_by_predictor(df_5, educ)
plot_mean_error_by_predictor(df_5, marital)
plot_mean_error_by_predictor(df_5, occ10)
plot_mean_error_by_predictor(df_5, region)
```
